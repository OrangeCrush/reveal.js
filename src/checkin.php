<?php
   ...
   $results = [];
   if($_POST['ISBN'] != ""){
      $getBookQuery = //TODO build query for getting books that are currently checked out (to see if they can be checked in)
...
<html>
   ...
   <body>
      <!--
          TODO build a form to allow users to enter the ISBN of a book to check in,
          and output if whether or not a given ISBN submitted was actually checked in or not
      -->
