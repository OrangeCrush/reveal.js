<?php
   ...
   $results = [];
   if($_POST['ISBN'] != ""){
      $getBookQuery = 'SELECT available from BOOKS where available=0 AND ISBN=' . $_POST['ISBN'];
...
<?
   ...
   if(mysql_num_rows($results) > 0){
     $updateQuery = "UPDATE BOOKS SET available=1 WHERE isbn=" . $_POST['ISBN'];
     mysql_query($updateQuery);
?>
     <b>Book checked in successfully! Thanks!</b><br>
<?
   }else if($_POST['ISBN'] != ""){
?>
      <b>Book was not checked in.</b><br>
<?
   }
